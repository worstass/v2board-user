...
import {
    ...
    faMobileAlt,
    faDollarSign,
    faGlobe, faBroadcastTower, faHeadset, faSignInAlt, faChevronRight, faLifeRing, faChevronLeft,
        ...
        <>
            ...
            <div className="callout">
                <Row className="container">
                    <Col md={12} span={24} className="mb-4 mb-lg-0">
                    ...
                    <Col md={4} span={8} className="text-center">
            ...
            <section id="purchase" className="bg-gr container">
                <Row className='container'>
                    <Col md={{span: 20, offset: 2}} lg={{span: 20, offset: 2}} span={24}
