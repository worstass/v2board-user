...
import {
    ...
    faMobileAlt,
    faDollarSign,
    faGlobe, faBroadcastTower, faHeadset, faSignInAlt,
} from '@fortawesome/free-solid-svg-icons'
// import { faBuysellads } from '@fortawesome/fontawesome-free-brands'
                                ...
                                <div className="pricing">
                                    ...
                                    <div className="pricing-padding">
                                        ...
                                        <div className="pricing-details">
                                            ...
                                            <div className="pricing-item">
                                                <div className="pricing-item-icon" style={{background: '#6574f7'}}> <FontAwesomeIcon icon={faCheck}/></div>
